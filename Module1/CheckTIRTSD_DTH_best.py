...
if __name__ == '__main__':
     for i in range(1,13):
         records = list(SeqIO.parse("DTH_fullcover_chr%s.fa"%(i),"fasta"))
         ...
         print(len(both))
         writeTofa("DTH_fullcover_chr%s.fa"%(i),"DTH_chr%s_fullcover_withTIR_best.fa"%(i),both,withTIR,"DTH")
         cat= "cat DTH_chr*_fullcover_withTIR_best.fa > DTH_fullcover_withTIR_best.fa"
         os.system(cat)
