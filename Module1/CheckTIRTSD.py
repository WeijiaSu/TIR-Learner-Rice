...
if __name__ == '__main__':
    ...
    for i in ["DTA","DTC","DTH","DTM","DTT"]:
        cat="cat *%s > %s"%(i+spliter+"select.fa",genome_Name+spliter+i+spliter+"candidates.fa")
        os.system(cat)
        rm ="rm *%s"%(i+spliter+"select.fa")
        os.system(rm)
        rm ="rm *%s"%(i+spliter+"select.csv")
        os.system(rm)
    for i in ["DTA","DTC","DTH","DTM","DTT"]:
        file=genome_Name+spliter+i+spliter+"candidates.fa"
