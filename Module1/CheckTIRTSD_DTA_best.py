...
if __name__ == '__main__':
     for i in range(1,13):
         records = list(SeqIO.parse("DTA_fullcover_chr%s.fa"%(i),"fasta"))
         ...
         print(len(both))
         writeTofa("DTA_fullcover_chr%s.fa"%(i),"DTA_chr%s_fullcover_withTIR_best.fa"%(i),both,withTIR,"DTA")
         cat= "cat DTA_chr*_fullcover_withTIR_best.fa > DTA_fullcover_withTIR_best.fa"
         os.system(cat)
