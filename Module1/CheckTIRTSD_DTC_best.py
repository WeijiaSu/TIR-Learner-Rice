...
if __name__ == '__main__':
     for i in range(1,13):
         records = list(SeqIO.parse("DTC_fullcover_chr%s.fa"%(i),"fasta"))
         ...
         print(len(both))
         writeTofa("DTC_fullcover_chr%s.fa"%(i),"DTC_chr%s_fullcover_withTIR_best.fa"%(i),both,withTIR,"DTC")
         cat= "cat DTC_chr*_fullcover_withTIR_best.fa > DTC_fullcover_withTIR_best.fa"
         os.system(cat)
